package org.codeoverflow.chatoverflow2.ui

import org.codeoverflow.chatoverflow.api.APIVersion
import org.codeoverflow.chatoverflow2.ui.CLI.UI.UI
...
object CLI {
  ...
  case class Config(pluginFolderPath: String = "plugins/",
                    ...
                    requirementPackage: String = "org.codeoverflow.chatoverflow2.requirement",
                    ui: UI = UI.REPL)
