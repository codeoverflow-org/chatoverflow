...
import org.codeoverflow.chatoverflow2.framework.helper.{PluggableLoader, PluginClassLoader}
import org.codeoverflow.chatoverflow2.framework.manager.PluginManagerStub
