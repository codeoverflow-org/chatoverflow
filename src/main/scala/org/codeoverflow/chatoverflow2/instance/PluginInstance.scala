...
import org.codeoverflow.chatoverflow2.framework.manager.{PluginManagerImpl, PluginManagerStub}
import org.codeoverflow.chatoverflow2.framework.{PluginCompatibilityState, PluginType}
